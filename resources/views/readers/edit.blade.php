        ...
        <form action="{{ route('readers.update', $readers->id) }}" method="POST">
            ...
            <div class="bg-body-secondary p-4">
                ...
                <div class="form-group mt-4">
                    ...
                    <input type="date" class="form-control" id="dob" name="dob" value="{{$readers->birthday}}" required>
                </div>
                <div class="form-group mt-4">
                ...
                <div class="form-group mt-4">
                    ...
                    <input type="text" class="form-control" id="phone_number" name="phone_number" value="{{$readers->phone}}" required>
                </div>
